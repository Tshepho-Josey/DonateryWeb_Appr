...
namespace DonateryWeb_Appr.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var obj = contextDB.AuthorisedUsers.FirstOrDefault(a => a.UserNames == objUser.UserNames && a.UserPassword == objUser.UserPassword);
            if (obj != null)
            {
